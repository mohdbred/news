...
curl_setopt_array($curl, array(
    CURLOPT_URL => "https://api.nytimes.com/svc/topstories/v2/home.json?country=us&pageSize=100&apiKey=20f81b719fad40058a5428ade7215931",
...
if ($err) {
    ...
    if (sizeof($res) > 15) {
        ...
        // Catching error 
        $subject_count = "Data from Home API is below 15 ->  " . date("Y-m-d H:i:s");
        $body_count = "Home - General API is not giving enough data: " . sizeof($res);
