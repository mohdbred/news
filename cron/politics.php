...
curl_setopt_array($curl, array(
    CURLOPT_URL => "https://api.nytimes.com/svc/topstories/v2/politics.json?country=us&pageSize=100&apiKey=20f81b719fad40058a5428ade7215931",
...
if ($err) {
    ...
    if (sizeof($res) > 15) {
        ...
        $sql_truncate = "TRUNCATE `politics`";
