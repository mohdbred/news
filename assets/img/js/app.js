            ...
            $.ajax({
                ...
                $.each(data, function (key, news) {
                    ...
                    if ((key > 10) && (key < 14)) {
                        ...
                        _topStories1 += '<div class="date-tp-2">october 2, 2015</div></article>';
                    ...
                    if ((key > 14) && (key < 18)) {
                        ...
                        _topStories2 += '<div class="date-tp-2">october 2, 2015</div></article>';
                    ...
                    if ((key > 15) && (key < 20)) {
                        ...
                        _trendingPost += '<h3 class="title-3"><a href="index._slideTemplatel">Fusce ac orci sagittis mattis magna t ultrices</a></h3>';
                        _trendingPost += '<div class="meta-tp-2"><div class="date"><span>october 2, 2015</span></div>';
                        _trendingPost += '<div class="category">';
                        _trendingPost += '<a href="index._slideTemplatel"><i class="li_pen"></i><span>business</span></a>';
