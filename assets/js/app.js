            ...
            $.ajax({
                ...
                $.each(data, function (key, news) {
                    ...
                    if (key < i) {
                        ...
                        _slideTemplate += '<h3 class="title-1"><a href="##1">' + news.description + '</a></h3>';
                    ...
                    if ((key > 10) && (key < 14)) {
                        ...
                        _topStories1 += ' <a href="#"><img src="' + news.urlToImage + '" height="98" width="126" alt="Spectr News Theme" class="adaptive" /></a>';
                    ...
                    if ((key > 14) && (key < 18)) {
                        ...
                        _topStories2 += ' <a href="#"><img src="' + news.urlToImage + '" height="98" width="126" alt="Spectr News Theme" class="adaptive" /></a>';
                    ...
                    if ((key > 15) && (key < 20)) {
                        ...
                        _trendingPost += ' <a href="#"><img src="' + news.urlToImage + '" height="186" width="260" alt="Spectr News Theme" class="adaptive" /></a>';
