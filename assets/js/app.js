            ...
            $.ajax({
                ...
                $.each(data, function (key, news) {
                    ...
                    if (key < i) {
                        ...
                        _slideTemplate += ' <a href="' + news.url + '" target="_blank" "><img src="' + news.urlToImage + '" height="471" width="760" alt="Spectr News Theme" class="adaptive" /></a>';
                        _slideTemplate += '</figure><div class="ptp-1-overlay"><div class="ptp-1-data">';
                        _slideTemplate += '<h3 class="title-1"><a href="index._slideTemplatel#1">' + news.description + '</a></h3>';
